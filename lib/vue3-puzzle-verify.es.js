import { mergeModels as M, useModel as E, openBlock as s, createElementBlock as t, createElementVNode as e, renderSlot as H, defineComponent as T, ref as a, onMounted as W, Fragment as N, createVNode as Q, Transition as J, withCtx as j, normalizeClass as z, unref as d, normalizeStyle as D, createCommentVNode as o, createBlock as q } from "vue";
const L = "data:image/svg+xml,%3csvg%20t='1735183612108'%20class='icon'%20viewBox='0%200%201024%201024'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20p-id='1450'%20width='200'%20height='200'%3e%3cpath%20d='M505.6%20121.6l396.8%20339.2c32%2025.6%2032%2070.4%200%2096l-396.8%20339.2c-25.6%2025.6-70.4%2019.2-89.6-6.4l0%200c-25.6-25.6-19.2-70.4%206.4-89.6L768%20512%20422.4%20217.6C396.8%20198.4%20390.4%20153.6%20416%20128l0%200C441.6%20102.4%20480%2096%20505.6%20121.6z'%20fill='%23fff'%20p-id='1451'%3e%3c/path%3e%3cpath%20d='M204.8%20121.6l396.8%20339.2c32%2025.6%2032%2070.4%200%2096l-396.8%20339.2c-25.6%2025.6-70.4%2019.2-89.6-6.4l0%200c-25.6-25.6-19.2-70.4%206.4-89.6L460.8%20512%20115.2%20217.6C89.6%20198.4%2089.6%20153.6%20108.8%20128l0%200C134.4%20102.4%20172.8%2096%20204.8%20121.6z'%20fill='%23fff'%20p-id='1452'%3e%3c/path%3e%3c/svg%3e", V = "data:image/svg+xml,%3csvg%20t='1735183685296'%20class='icon'%20viewBox='0%200%201024%201024'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20p-id='2434'%20width='200'%20height='200'%3e%3cpath%20d='M913.017%20237.02c-25.311-25.312-66.349-25.312-91.66%200l-412.475%20412.474-206.237-206.237c-25.312-25.312-66.35-25.312-91.661%200s-25.312%2066.35%200%2091.66l252.067%20252.067c0.729%200.73%201.439%201.402%202.134%202.029%2025.434%2023.257%2064.913%2022.585%2089.527-2.029l458.303-458.303c25.313-25.312%2025.313-66.35%200.001-91.661z'%20fill='%23fff'%20p-id='2435'%3e%3c/path%3e%3c/svg%3e", S = "data:image/svg+xml,%3csvg%20t='1737879873464'%20class='icon'%20viewBox='0%200%201024%201024'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20p-id='9159'%20width='200'%20height='200'%3e%3cpath%20d='M831.3856%20107.264a60.3392%2060.3392%200%200%201%2085.3376%2085.3504L597.3376%20512%20916.736%20831.3856a60.352%2060.352%200%200%201%202.432%2082.7648l-2.432%202.5728a60.3392%2060.3392%200%200%201-85.3376%200L512%20597.3376%20192.6144%20916.736a60.352%2060.352%200%200%201-82.7648%202.432l-2.5728-2.432a60.3392%2060.3392%200%200%201%200-85.3376L426.6624%20512%20107.264%20192.6144a60.352%2060.352%200%200%201-2.432-82.7648l2.432-2.5728a60.3392%2060.3392%200%200%201%2085.3376%200L512%20426.6624%20831.3856%20107.264z'%20fill='%23ffffff'%20p-id='9160'%3e%3c/path%3e%3c/svg%3e", O = "data:image/svg+xml,%3csvg%20t='1738747760234'%20class='icon'%20viewBox='0%200%201024%201024'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20p-id='17010'%20width='200'%20height='200'%3e%3cpath%20d='M1024%20512c0%20282.72-229.28%20512-512%20512S0%20794.72%200%20512%20229.28%200%20512%200s512%20229.28%20512%20512'%20fill='%235A89FF'%20p-id='17011'%3e%3c/path%3e%3cpath%20d='M690.72%20812l-24.96-41.76c90.56-54.08%20146.72-152.96%20146.72-258.24%200-165.6-134.72-300.48-300.48-300.48v-48.64c192.48%200%20349.12%20156.64%20349.12%20349.12%200%20122.24-65.28%20237.28-170.4%20300z'%20fill='%23FFFFFF'%20p-id='17012'%3e%3c/path%3e%3cpath%20d='M558.72%20295.52l-66.56-94.4c-3.68-5.28-5.28-11.84-4.16-18.24%201.12-6.4%204.64-12%209.92-15.84l94.4-66.56%2028.16%2039.84-74.4%2052.48%2052.48%2074.4-39.84%2028.32zM512%20861.12c-192.48%200-349.12-156.64-349.12-349.12%200-126.24%2068.48-243.04%20178.56-304.8l23.84%2042.56c-94.88%2053.12-153.76%20153.6-153.76%20262.24%200%20165.6%20134.72%20300.48%20300.48%20300.48v48.64z'%20fill='%23FFFFFF'%20p-id='17013'%20data-spm-anchor-id='a313x.search_index.0.i16.472a3a81Xnqcy5'%20class=''%3e%3c/path%3e%3cpath%20d='M431.68%20923.2l-28.16-39.84%2074.4-52.48-52.48-74.4%2039.84-28%2066.56%2094.4c3.68%205.28%205.28%2011.84%204.16%2018.24-1.12%206.4-4.64%2012-9.92%2015.84l-94.4%2066.24z'%20fill='%23FFFFFF'%20p-id='17014'%3e%3c/path%3e%3c/svg%3e", R = (u, f) => {
  ...
  emits: /* @__PURE__ */ M(["update:visible"], ["update:modelValue"]),
  setup(u, { emit: f }) {
    const v = f;
    E(u, "modelValue");
    const i = () => {
...
}, s2 = ["src"], t2 = { class: "img-bg" }, c2 = ["src"], a2 = ["src"], o2 = ["src"], n2 = ["src"], i2 = ["src"], u2 = {
  key: 0,
  class: "slider-tips"
}, r2 = { class: "puzzle-wrapper" }, d2 = ["src"], m2 = { class: "img-bg" }, v2 = ["src"], g2 = ["src"], f2 = ["src"], p2 = ["src"], h2 = ["src"], k2 = {
  key: 0,
  class: "slider-tips"
}, w2 = /* @__PURE__ */ T({
  name: "PuzzleVerify",
  ...
  setup(u, { expose: f, emit: v }) {
    const i = v, c = E(u, "modelValue"), l = a("default"), _ = a(), w = a(), b = a(), p = a(!1), m = a({
    ...
    const U = [
      ...
      k.value && (r.value = n.pageX - P.value, !(r.value < 0 || r.value > 261) && (w.value.style.transform = `translateX(${r.value}px)`, h.value.left = `${r.value}px`, b.value.style.width = r.value + 25 + "px", i("onDrag")));
    }, B = (n) => {
      c.value || (k.value = !0, P.value = n.clientX, document.addEventListener("mousemove", A), document.addEventListener("mouseup", G));
    }, X = () => {
      l.value = "default", w.value.style.transform = "translateX(0px)", h.value.left = "5px", b.value.style.width = "0px";
    }, G = () => {
      k.value = !1, i("onDragEnd"), r.value >= m.value.x - 2 && r.value <= m.value.x + 2 ? (c.value = !0, l.value = "success", setTimeout(() => {
        C();
      }, 1e3), i("onSuccess", c.value)) : (c.value = !1, i("onFail", c.value), l.value = "fail", setTimeout(() => {
        X(), y();
      }, 1e3)), document.removeEventListener("mousemove", A), document.removeEventListener("mouseup", G);
    }, y = () => {
      const n = Math.floor(Math.random() * 8);
      m.value = U[n], h.value.left = "5px";
    }, I = () => {
      y(), c.value = !1, X();
    };
    return f({
      ...
      n.type === "insert" || n.type === "popover" ? (s(), t("div", l2, [
        Q(J, { name: "slide-up-down" }, {
          default: j(() => [
            x.value ? (s(), t("div", {
              key: 0,
              class: z({ popover: n.type === "popover" })
            }, [
              e("img", {
                src: d(O),
                class: "refresh",
              ...
              e("div", {
                class: "img-block",
                style: D({ left: h.value.left })
              }, [
                e("img", {
                  src: m.value.blockImg,
                  alt: ""
                }, null, 8, a2)
              ], 4)
            ], 2)) : o("", !0)
        ...
        e("div", {
          ...
          ref_key: "drag",
          ref: _,
          onMousemove: g[0] || (g[0] = (F) => x.value = !0),
          onMouseleave: g[1] || (g[1] = (F) => x.value = !1)
        }, [
          e("div", {
            class: "slider-fill",
            ref_key: "sliderFill",
          ...
          l.value === "default" && !k.value ? (s(), t("div", u2, "按住按钮完成验证")) : o("", !0)
        ], 34)
      ])) : o("", !0),
      n.type === "modal" && p.value ? (s(), q(e2, {
        key: 1,
        visible: p.value,
        "onUpdate:visible": g[2] || (g[2] = (F) => p.value = F)
      }, {
        default: j(() => [
          e("div", r2, [
            e("img", {
            ...
            e("div", {
              ...
              l.value === "default" && !k.value ? (s(), t("div", k2, "按住按钮完成验证")) : o("", !0)
            ], 2)
          ])
        ]),
        _: 1
...
}), b2 = /* @__PURE__ */ R(w2, [["__scopeId", "data-v-8f9258a8"]]), _2 = function(u) {
  u.component("PuzzleVerify", b2);
}, y2 = { install: _2 };
export {
  b2 as PuzzleVerify,
  y2 as default
